...
{
    {
        ...
        cmd << "g++ -Wall -march=native -gdwarf-3 -pthread -g -std=c++1y -c ";
        if (release)
            cmd << "-O3 ";
        if (exists(incDir))
            cmd << "-I" << incDir << " ";
    ...
    {
        std::ostringstream cmd;
        cmd << "g++ -Wall -march=native -gdwarf-3 -pthread -g -std=c++1y -MM -c ";
        if (release)
            cmd << "-O3 ";
        if (exists(incDir))
            cmd << "-I" << incDir << " ";
    ...
    {
        std::ostringstream cmd;
        cmd << "g++ -Wall -march=native -gdwarf-3 -pthread -g -std=c++1y -E -c ";
        if (release)
            cmd << "-O3 ";
        if (exists(incDir))
            cmd << "-I" << incDir << " ";
